...
namespace AspCoreCrud.Controllers
{
    public class DrinksController : Controller
    {
        ...
        [HttpGet]
        public IActionResult GetDrinksName()
        {
            IEnumerable<string> coldDrinks = db.tblColdDrinks.Select(s=>s.strColdDrinksName);
            return Json(new { data = coldDrinks });
        ...
        [HttpPost]
        public IActionResult DeleteAllLess()
        {
